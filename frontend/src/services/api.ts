...
export const FALLBACK_PREDICTIONS: Record<string, PredictResponse> = {
  ...
  AR12673_Impending_M_Flare: {
    ...
    target_active_region: "AR-12673 (Moderate Shear)",
    data_mode: "CALIBRATED_CONVLSTM",
    mx_probability_24h: 58.2,
    mx_probability_48h: 74.6,
    calibrated_probability: 58.2,
    model_confidence: 89.1,
    predicted_class: "M-Class Flare",
    multiclass_distribution: {
      Quiet_B: 8.4,
      C_Class: 33.4,
      M_Class: 46.8,
    ...
    estimated_peak_flux: "M4.2 (4.2 × 10⁻⁵ W/m²)",
    risk_level: "HIGH",
    explanation_available: true,
    optical_proxies: {
      peak_intensity: 0.82,
